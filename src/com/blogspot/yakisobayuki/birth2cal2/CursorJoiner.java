...
public final class CursorJoiner implements Iterator<CursorJoiner.Result>,
		Iterable<CursorJoiner.Result> {
	...
	public CursorJoiner(Cursor cursorLeft, String[] columnNamesLeft,
